...
(function ($) {
    ...
    */
    ...
    window.addEventListener('scroll', function () {
        ...
        // Quando o usuário chega na parte inferior da página
        if (windowHeight + scrollPosition >= documentHeight - 100) {
            whatsappBtn.style.visibility = 'visible'; // Torna o botão visível
        } else {
            whatsappBtn.style.visibility = 'hidden'; // Torna o botão invisível
        }
    });
